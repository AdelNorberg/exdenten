import Vue from 'vue';
import { SET_PROFILE_DATA, SET_PROFILE_IMG, 
         SET_NOTIFICATION_MSGS, SET_BASE_SETTINGS
       } from './mutation-types';
import { LOAD_USER_PROFILE, LOAD_AVATAR,
         LOAD_USER_NOTIFICATION, UPDATE_PROFILE  
       } from './action-types';
